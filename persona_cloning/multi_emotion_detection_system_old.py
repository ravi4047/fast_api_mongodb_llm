...
#     async def analyze_emotional_state(self, text: str, user_id: str|None = None) -> EmotionalState:
...
#                 weight = len(instances) * np.mean([inst["confidence"] for inst in instances])
#                 total_weight += weight
